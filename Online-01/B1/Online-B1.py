...
# Data transforms (augmentation for training, normalization for both)
...
class DepthwiseSeparableConv(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, stride=1):
        super().__init__()
        # depthwise conv: in_ch -> in_ch, groups=in_ch
...
class ConvNet(nn.Module):
    ...
    def __init__(self, num_classes=10):
        ...
        for out_ch, stride in self.cfg:
            layers.append(DepthwiseSeparableConv(in_ch, out_ch, stride=stride))
            in_ch = out_ch
